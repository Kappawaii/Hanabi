...
public class Player {
	...
	private void playCard() {
		Card c = interactionManager.selectCardInOwnCards("Choisissez la carte ‡ jouer :" + System.lineSeparator(),
				cards);
		if (cards.remove(c)) {
	...
	private void discardCard() {
		Card c = interactionManager.selectCardInOwnCards("Choisissez la carte ‡ dÈfausser :" + System.lineSeparator(),
				cards);
	...
	private void displayFail(Card c) {
		view.printString("√âchec : Carte " + c + " part dans la d√©fausse.");
	}
